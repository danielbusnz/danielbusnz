                    ...
                    <header className="mx-auto w-full max-w-2xl px-6 pt-12 pb-6">
                        <div className="font-mono text-sm leading-8">
                            <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                                <span style={{ color: "var(--ctp-mauve)" }}>fn</span>
                                <Link
                                    href="/"
                                ...
                                <span className="flex items-center gap-2">
                                    ...
                                    <span style={punct}>,</span>
                                    <a
                                        href="https://x.com/rackSpreader1"
                                        target="_blank"
                                        rel="noreferrer"
                                        aria-label="X"
                                        className={iconLink}
                                    ...
                                    <span style={punct}>,</span>
                                    <a
                                        href="mailto:danielbusnz@gmail.com"
                                        aria-label="Email"
                                        className={iconLink}
                                        style={iconColor}
                                    >
                                    ...
                                    <span style={punct}>,</span>
                                    <a
                                        href="https://linktr.ee/danielbusnz"
                                        target="_blank"
                                        rel="noreferrer"
                                        aria-label="Linktree"
                                        className={iconLink}
                                    ...
                                    >
                                        ...
                                        >
                                            <path d="M4 10h16" />
                                            <path d="m6.5 4.5 11 11" />
                                            <path d="m6.5 15.5 11 -11" />
                                            <path d="M12 10V2" />
                                            <path d="M12 15v7" />
                                        </svg>
                                    </a>
